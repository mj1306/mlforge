...
from app.api.deps import TrainingServiceDep
...
async def start_training(
    config: ModelConfig, response: Response, training_service: TrainingServiceDep
) -> dict:
    try:
        record = training_service.start(config)
